...
const MASKED = [
  ...
  ['url with token query', 'abre https://api.example.com/v1/x?token=abc123secret', ['abc123secret']],
  ['url basic auth', 'https://admin:hunter2@internal.example.com/db', ['hunter2']],
